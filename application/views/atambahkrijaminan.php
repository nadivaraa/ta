                            ...
                            <div class="card">
                                <div class="row ps-2 pt-2">
                                    <div class="col-6 col-md-6">
                                        <h4 class="card-title">Tambah Kriteria Jaminan</h4>        
                                    </div>
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" action="<?php echo base_url('admin/aprostambahkrijaminan') ?>" method="POST">
                                        
                                        <div class="mb-1">
                                            <label class="form-label" for="basic-addon-name">Jenis Kriteria</label>
                                            <input type="text" id="basic-addon-name" class="form-control" placeholder="Jenis Krteria" name="krijaminan_jenis" aria-label="Name" aria-describedby="basic-addon-name" required />
                                        </div>
                                        <div class="mb-1">
                                            <label class="form-label" for="basic-addon-name">Bobot Kriteria</label>
                                            <input type="text" id="basic-addon-name" class="form-control" placeholder="Bobot Kriteria" aria-label="Name" name="krijaminan_bobot" aria-describedby="basic-addon-name" required />
                                        </div>
