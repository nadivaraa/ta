                ...
                <section id="dashboard-ecommerce">
                    ...
                    <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" action="<?= site_url('admin/aprosupdatekrikemba')?>" method="POST" novalidate>
                                        
                                        <div class="mb-1">
                                            <label class="form-label" for="basic-addon-name">Jenis Kriteria</label>
                                            <input type="text" id="basic-addon-name" class="form-control" placeholder="Jenis Krteria" name="krikemba_jenis" aria-label="Name" aria-describedby="basic-addon-name" value="<?= $krikemba->NAMA_KMB?>" required/>
                                        </div>
                                        <div class="mb-1">
                                            <label class="form-label" for="basic-addon-name">Bobot Kriteria</label>
                                            <input type="text" id="basic-addon-name" class="form-control" placeholder="Bobot Kriteria" name="krikemba_bobot" aria-label="Name" aria-describedby="basic-addon-name" value="<?= $krikemba->BOBOT_KMB?>" required/>
                                        </div>
                                        <div style="float: right;">
                                            <input type="hidden" id="basic-addon-name" class="form-control" name="id_kmb" placeholder="Bobot Kriteria" aria-label="Name" aria-describedby="basic-addon-name" value="<?= $krikemba->ID_KMB?>" required />
