                            ...
                            <div class="card">
                                <div class="row ps-2 pt-2">
                                    <div class="col-6 col-md-6">
                                        <h4 class="card-title">Edit Kriteria Jaminan</h4>        
                                    </div>
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" action="<?= site_url('admin/aprosupdatekrijaminan')?>" method="POST" novalidate>
                                        
                                        <div class="mb-1">
                                            <label class="form-label" for="basic-addon-name">Jenis Kriteria</label>
                                            <input type="text" id="basic-addon-name" class="form-control" placeholder="Jenis Krteria" aria-label="Name" aria-describedby="basic-addon-name" name= "krijaminan_jenis" value="<?= $krijaminan->NAMA_KJ?>" required />
                                        </div>
                                        <div class="mb-1">
                                            <label class="form-label" for="basic-addon-name">Bobot Kriteria</label>
                                            <input type="text" id="basic-addon-name" class="form-control" placeholder="Bobot Kriteria" aria-label="Name" aria-describedby="basic-addon-name" name= "krijaminan_bobot" value="<?= $krijaminan->BOBOT_KJ?>" required />
                                        </div>
                                        <div style="float: right;">
                                        <input type="hidden" id="basic-addon-name" class="form-control" name="id_kj" placeholder="Bobot Kriteria" aria-label="Name" aria-describedby="basic-addon-name" value="<?= $krijaminan->ID_KJ?>" required />
