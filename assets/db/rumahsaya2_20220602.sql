...
--
-- Host: localhost
-- Generation Time: Jun 02, 2022 at 02:55 AM
...
(19, 18, 'http://127.0.0.1/ta/uploads/dok_sertif/dok_sertif_Wahyu_Karyawan.pdf', 'http://127.0.0.1/ta/uploads/dok_imb/dok_imb_Wahyu_Karyawan.pdf', 'http://127.0.0.1/ta/uploads/dok_pbb/dok_pbb_Wahyu_Karyawan.pdf', 'http://127.0.0.1/ta/uploads/dok_aktajb/dok_aktajb_Wahyu_Karyawan.pdf');
...
('Wahyu', '827ccb0eea8a706c4c34a16891f84e7b', 'wahyu@gmail.com', '08939842349', '1', '1980-05-14'),
('Wahyu Karyawan', '827ccb0eea8a706c4c34a16891f84e7b', 'wahyukaryawan@gmail.com', '08939534', '2', '1990-05-09'),
('Wahyu Professional', '827ccb0eea8a706c4c34a16891f84e7b', 'wahyuprof@gmail.com', '0893842453', '1', '1985-05-08');
...
('jouvan@gmail.com', 0.84089641525371, 0.94574160900318, 1, 0.79527072876705, 0.63245553203368, 0.19014706548841),
('galangsh@gmail.com', 0.84089641525371, 0.94574160900318, 0.94574160900318, 1, 0.75212061861728, 0.2261242431757),
('afifah@gmail.com', 0.94574160900318, 0.94574160900318, 1, 0.94574160900318, 0.84589701075245, 0.25431801313018),
('khusnulj@gmail.com', 0.94574160900318, 0.94574160900318, 0.79527072876705, 0.94574160900318, 0.67271713220297, 0.20225167164062),
('ardhi@gmail.com', 0.84089641525371, 0.94574160900318, 0.66874030497642, 0.79527072876705, 0.42294850537623, 0.12715900656509);
...
(37, 'wahyu@gmail.com', NULL, 1, 0, 0, ''),
(38, 'wahyukaryawan@gmail.com', 10, 2, 3, 0, ''),
(39, 'wahyuprof@gmail.com', NULL, 1, 0, 0, '');
...
(17, 'wahyu@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
(18, 'wahyukaryawan@gmail.com', 4, 1, 0, 1, 1, 0, 1, 1, 1, 3, ''),
(19, 'wahyuprof@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL);
...
(24, 'wahyu@gmail.com', NULL, NULL, NULL, NULL, 42, 0, 0, 0, 0, 0, 0, NULL),
(25, 'wahyukaryawan@gmail.com', NULL, NULL, 743900000, NULL, 32, 0, 0, 74390000, 669510000, 0, 0, NULL),
(26, 'wahyuprof@gmail.com', NULL, NULL, NULL, NULL, 37, 0, 0, 0, 0, 0, 0, NULL);
...
(15, 'wahyu@gmail.com', NULL, 0, NULL),
(16, 'wahyukaryawan@gmail.com', NULL, 2, NULL),
(17, 'wahyuprof@gmail.com', NULL, 0, NULL);
...
--
ALTER TABLE `dokumen_jaminan`
  MODIFY `ID_DJ` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `verif_dokumen`
  MODIFY `ID_VD` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `verif_jaminan`
--
ALTER TABLE `verif_jaminan`
  MODIFY `ID_VJ` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `verif_kemampuan_bayar`
--
ALTER TABLE `verif_kemampuan_bayar`
  MODIFY `ID_VKB` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `verif_pengecekan_slik`
--
ALTER TABLE `verif_pengecekan_slik`
  MODIFY `ID_VPS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
